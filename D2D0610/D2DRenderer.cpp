...
D2DRenderer::D2DRenderer() : pRenderTarget(0), _brushes(10, nullptr)
{
}
...
BOOL D2DRenderer::InitDirect2D(HWND& hWnd)
{
	...
	pRenderTarget->CreateSolidColorBrush(D2D1::ColorF(D2D1::ColorF::Black), &_brushes[0]);
	pRenderTarget->CreateSolidColorBrush(D2D1::ColorF(D2D1::ColorF::Gray), &_brushes[1]);
